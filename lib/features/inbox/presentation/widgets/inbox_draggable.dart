...
class InboxDraggable<T extends Object> extends StatefulWidget {
  ...
  @override
  State<InboxDraggable<T>> createState() => _InboxDraggableState<T>();
}

class _InboxDraggableState<T extends Object> extends State<InboxDraggable<T>> {
  @override
  void initState() {
    super.initState();
...
///  * [pointerDragAnchorStrategy], which displays the feedback anchored at the
///    position of the touch that started the drag.
typedef DragAnchorStrategy = Offset Function(InboxDraggable<Object> draggable, BuildContext context, Offset position);
...
Offset childDragAnchorStrategy(InboxDraggable<Object> draggable, BuildContext context, Offset position) {
...
// ignore: must_be_immutable
class InboxLongPressDraggable<T extends Object> extends InboxDraggable<T> {
  /// Creates a widget that can be dragged starting from long press.
  ///
  /// If [maxSimultaneousDrags] is non-null, it must be non-negative.
  InboxLongPressDraggable({
    super.key,
...
class _DragAvatar<T extends Object> extends Drag {
  _DragAvatar({
    ...
    required this.scaleFactor,
  }) : _position = initialPosition / scaleFactor {
    _entry = OverlayEntry(builder: _build);
    overlayState.insert(_entry!);
    updateDrag(initialPosition / scaleFactor);
  }
  ...
  void update(DragUpdateDetails details) {
    ...
    _position += (_restrictAxis(details.delta) / scaleFactor);
