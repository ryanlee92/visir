...
class SfPdfViewerTheme extends InheritedTheme {
  ...
  const SfPdfViewerTheme({Key? key, required this.data, required this.child}) : super(key: key, child: child);
  ...
  static SfPdfViewerThemeData? of(BuildContext context) {
    final SfPdfViewerTheme? pdfViewerTheme = context.dependOnInheritedWidgetOfExactType<SfPdfViewerTheme>();
  ...
  Widget wrap(BuildContext context, Widget child) {
    final SfPdfViewerTheme? ancestorTheme = context.findAncestorWidgetOfExactType<SfPdfViewerTheme>();
    return identical(this, ancestorTheme) ? child : SfPdfViewerTheme(data: data, child: child);
  }
}
...
class SfPdfViewerThemeData with Diagnosticable {
  ...
  factory SfPdfViewerThemeData(
    ...
    backgroundColor ??= isLight ? const Color(0xFFD6D6D6) : const Color(0xFF303030);
    scrollHeadStyle ??= PdfScrollHeadStyle(
      backgroundColor: isLight ? const Color(0xFFFAFAFA) : const Color(0xFF424242),
    );
    bookmarkViewStyle ??= PdfBookmarkViewStyle(
      backgroundColor: isLight ? Colors.white : const Color(0xFF212121),
      closeIconColor: isLight ? Colors.black.withValues(alpha: 0.54) : Colors.white.withValues(alpha: 0.54),
      backIconColor: isLight ? Colors.black.withValues(alpha: 0.54) : Colors.white.withValues(alpha: 0.54),
      headerBarColor: isLight ? const Color(0xFFFAFAFA) : const Color(0xFF424242),
      navigationIconColor: isLight ? Colors.black.withValues(alpha: 0.54) : Colors.white.withValues(alpha: 0.54),
      selectionColor: isLight ? const Color.fromRGBO(0, 0, 0, 0.08) : const Color.fromRGBO(255, 255, 255, 0.12),
      titleSeparatorColor: isLight ? const Color.fromRGBO(0, 0, 0, 0.16) : const Color.fromRGBO(255, 255, 255, 0.16),
    );
    ...
    hyperlinkDialogStyle ??= PdfHyperlinkDialogStyle(
      backgroundColor: isLight ? Colors.white : const Color(0xFF424242),
      closeIconColor: isLight ? Colors.black.withValues(alpha: 0.6) : Colors.white.withValues(alpha: 0.6),
    );
    passwordDialogStyle ??= PdfPasswordDialogStyle(
      backgroundColor: isLight ? Colors.white : const Color(0xFF424242),
      closeIconColor: isLight ? Colors.black.withValues(alpha: 0.6) : Colors.white.withValues(alpha: 0.6),
      visibleIconColor: isLight ? Colors.black.withValues(alpha: 0.6) : Colors.white.withValues(alpha: 0.6),
    );
  ...
  SfPdfViewerThemeData copyWith(
    ...
    return SfPdfViewerThemeData.raw(
      ...
      paginationDialogStyle: paginationDialogStyle ?? this.paginationDialogStyle,
  ...
  static SfPdfViewerThemeData? lerp(SfPdfViewerThemeData? a, SfPdfViewerThemeData? b, double t) {
    if (a == null && b == null) {
      return null;
    }
    return SfPdfViewerThemeData(
        ...
        scrollStatusStyle: PdfScrollStatusStyle.lerp(a.scrollStatusStyle, b.scrollStatusStyle, t),
        scrollHeadStyle: PdfScrollHeadStyle.lerp(a.scrollHeadStyle, b.scrollHeadStyle, t),
        bookmarkViewStyle: PdfBookmarkViewStyle.lerp(a.bookmarkViewStyle, b.bookmarkViewStyle, t),
        paginationDialogStyle: PdfPaginationDialogStyle.lerp(a.paginationDialogStyle, b.paginationDialogStyle, t),
        hyperlinkDialogStyle: PdfHyperlinkDialogStyle.lerp(a.hyperlinkDialogStyle, b.hyperlinkDialogStyle, t),
        passwordDialogStyle: PdfPasswordDialogStyle.lerp(a.passwordDialogStyle, b.passwordDialogStyle, t));
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(ColorProperty('progressBarColor', progressBarColor, defaultValue: defaultData.progressBarColor));
    properties.add(DiagnosticsProperty<PdfScrollStatusStyle>('scrollStatusStyle', scrollStatusStyle, defaultValue: defaultData.scrollStatusStyle));
    properties.add(DiagnosticsProperty<PdfScrollHeadStyle>('scrollHeadStyle', scrollHeadStyle, defaultValue: defaultData.scrollHeadStyle));
    properties.add(DiagnosticsProperty<PdfBookmarkViewStyle>('bookmarkViewStyle', bookmarkViewStyle, defaultValue: defaultData.bookmarkViewStyle));
    properties
        .add(DiagnosticsProperty<PdfPaginationDialogStyle>('paginationDialogStyle', paginationDialogStyle, defaultValue: defaultData.paginationDialogStyle));
    properties.add(DiagnosticsProperty<PdfHyperlinkDialogStyle>('hyperlinkDialogStyle', hyperlinkDialogStyle, defaultValue: defaultData.hyperlinkDialogStyle));
    properties.add(DiagnosticsProperty<PdfPasswordDialogStyle>('passwordDialogStyle', passwordDialogStyle, defaultValue: defaultData.passwordDialogStyle));
  }
}
...
class PdfScrollStatusStyle {
  ...
  bool operator ==(Object other) {
    ...
    return other is PdfScrollStatusStyle && other.backgroundColor == backgroundColor && other.pageInfoTextStyle == pageInfoTextStyle;
  }

  /// Linearly interpolate between two styles.
  static PdfScrollStatusStyle? lerp(PdfScrollStatusStyle? a, PdfScrollStatusStyle? b, double t) {
    if (a == null && b == null) {
      return null;
    }
    return PdfScrollStatusStyle(
        backgroundColor: Color.lerp(a!.backgroundColor, b!.backgroundColor, t), pageInfoTextStyle: TextStyle.lerp(a.pageInfoTextStyle, b.pageInfoTextStyle, t));
  }
}
...
class PdfScrollHeadStyle {
  ...
  bool operator ==(Object other) {
    ...
    return other is PdfScrollHeadStyle && other.backgroundColor == backgroundColor && other.pageNumberTextStyle == pageNumberTextStyle;
  }

  /// Linearly interpolate between two styles.
  static PdfScrollHeadStyle? lerp(PdfScrollHeadStyle? a, PdfScrollHeadStyle? b, double t) {
    if (a == null && b == null) {
      return null;
    }
    return PdfScrollHeadStyle(
        backgroundColor: Color.lerp(a!.backgroundColor, b!.backgroundColor, t),
        pageNumberTextStyle: TextStyle.lerp(a.pageNumberTextStyle, b.pageNumberTextStyle, t));
  }
}
...
class PdfBookmarkViewStyle {
  ...
  /// Linearly interpolate between two styles.
  static PdfBookmarkViewStyle? lerp(PdfBookmarkViewStyle? a, PdfBookmarkViewStyle? b, double t) {
    if (a == null && b == null) {
      return null;
    }
    return PdfBookmarkViewStyle(
        ...
        navigationIconColor: Color.lerp(a.navigationIconColor, b.navigationIconColor, t),
        selectionColor: Color.lerp(a.selectionColor, b.selectionColor, t),
        titleSeparatorColor: Color.lerp(a.titleSeparatorColor, b.titleSeparatorColor, t),
...
class PdfPaginationDialogStyle {
  ...
  /// Linearly interpolate between two styles.
  static PdfPaginationDialogStyle? lerp(PdfPaginationDialogStyle? a, PdfPaginationDialogStyle? b, double t) {
    if (a == null && b == null) {
      return null;
    }
    return PdfPaginationDialogStyle(
        backgroundColor: Color.lerp(a!.backgroundColor, b!.backgroundColor, t),
        headerTextStyle: TextStyle.lerp(a.headerTextStyle, b.headerTextStyle, t),
        inputFieldTextStyle: TextStyle.lerp(a.inputFieldTextStyle, b.inputFieldTextStyle, t),
        hintTextStyle: TextStyle.lerp(a.hintTextStyle, b.hintTextStyle, t),
        pageInfoTextStyle: TextStyle.lerp(a.pageInfoTextStyle, b.pageInfoTextStyle, t),
        validationTextStyle: TextStyle.lerp(a.validationTextStyle, b.validationTextStyle, t),
...
class PdfHyperlinkDialogStyle {
  ...
  const PdfHyperlinkDialogStyle(
      {this.backgroundColor, this.headerTextStyle, this.contentTextStyle, this.openTextStyle, this.cancelTextStyle, this.closeIconColor});
  ...
  /// Linearly interpolate between two styles.
  static PdfHyperlinkDialogStyle? lerp(PdfHyperlinkDialogStyle? a, PdfHyperlinkDialogStyle? b, double t) {
    if (a == null && b == null) {
      return null;
    }
...
class PdfPasswordDialogStyle {
  ...
  /// Linearly interpolate between two styles.
  static PdfPasswordDialogStyle? lerp(PdfPasswordDialogStyle? a, PdfPasswordDialogStyle? b, double t) {
    if (a == null && b == null) {
      return null;
    }
    return PdfPasswordDialogStyle(
      ...
      contentTextStyle: TextStyle.lerp(a.contentTextStyle, b.contentTextStyle, t),
      inputFieldTextStyle: TextStyle.lerp(a.inputFieldTextStyle, b.inputFieldTextStyle, t),
      inputFieldHintTextStyle: TextStyle.lerp(a.inputFieldHintTextStyle, b.inputFieldHintTextStyle, t),
      inputFieldLabelTextStyle: TextStyle.lerp(a.inputFieldLabelTextStyle, b.inputFieldLabelTextStyle, t),
      ...
      inputFieldBorderColor: Color.lerp(a.inputFieldBorderColor, b.inputFieldBorderColor, t),
