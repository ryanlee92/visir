...
class SfTheme extends StatelessWidget {
  ...
  static SfThemeData of(BuildContext context) {
    final _SfInheritedTheme? inheritedTheme = context.dependOnInheritedWidgetOfExactType<_SfInheritedTheme>();
    return inheritedTheme?.data ?? (context.brightness == Brightness.light ? SfThemeData.light() : SfThemeData.dark());
  }
...
class _SfInheritedTheme extends InheritedTheme {
  const _SfInheritedTheme({Key? key, this.data, required Widget child}) : super(key: key, child: child);

  final SfThemeData? data;

  @override
  bool updateShouldNotify(_SfInheritedTheme oldWidget) => data != oldWidget.data;

  @override
  Widget wrap(BuildContext context, Widget child) {
    final _SfInheritedTheme? ancestorTheme = context.findAncestorWidgetOfExactType<_SfInheritedTheme>();
    return identical(this, ancestorTheme) ? child : SfTheme(data: data, child: child);
  }
}
...
class SfThemeData with Diagnosticable {
  ...
  factory SfThemeData(
    ...
    pdfViewerThemeData = pdfViewerThemeData ?? SfPdfViewerThemeData(brightness: brightness);
    chartThemeData = chartThemeData ?? SfChartThemeData(brightness: brightness);
    calendarThemeData = calendarThemeData ?? SfCalendarThemeData(brightness: brightness);
    dataGridThemeData = dataGridThemeData ?? SfDataGridThemeData(brightness: brightness);
    dateRangePickerThemeData = dateRangePickerThemeData ?? SfDateRangePickerThemeData(brightness: brightness);
    barcodeThemeData = barcodeThemeData ?? SfBarcodeThemeData(brightness: brightness);
    ...
    rangeSelectorThemeData = rangeSelectorThemeData ?? SfRangeSelectorThemeData(brightness: brightness);
  ...
  SfThemeData copyWith({
    ...
    return SfThemeData.raw(
        ...
        dateRangePickerThemeData: dateRangePickerThemeData ?? this.dateRangePickerThemeData,
        ...
        rangeSelectorThemeData: rangeSelectorThemeData ?? this.rangeSelectorThemeData,
  ...
  static SfThemeData lerp(SfThemeData? a, SfThemeData? b, double t) {
    ...
    return SfThemeData.raw(
        ...
        pdfViewerThemeData: SfPdfViewerThemeData.lerp(a!.pdfViewerThemeData, b!.pdfViewerThemeData, t)!,
        chartThemeData: SfChartThemeData.lerp(a.chartThemeData, b.chartThemeData, t)!,
        calendarThemeData: SfCalendarThemeData.lerp(a.calendarThemeData, b.calendarThemeData, t)!,
        dataGridThemeData: SfDataGridThemeData.lerp(a.dataGridThemeData, b.dataGridThemeData, t)!,
        dataPagerThemeData: SfDataPagerThemeData.lerp(a.dataPagerThemeData, b.dataPagerThemeData, t)!,
        dateRangePickerThemeData: SfDateRangePickerThemeData.lerp(a.dateRangePickerThemeData, b.dateRangePickerThemeData, t)!,
        barcodeThemeData: SfBarcodeThemeData.lerp(a.barcodeThemeData, b.barcodeThemeData, t)!,
        gaugeThemeData: SfGaugeThemeData.lerp(a.gaugeThemeData, b.gaugeThemeData, t)!,
        sliderThemeData: SfSliderThemeData.lerp(a.sliderThemeData, b.sliderThemeData, t)!,
        rangeSelectorThemeData: SfRangeSelectorThemeData.lerp(a.rangeSelectorThemeData, b.rangeSelectorThemeData, t)!,
        rangeSliderThemeData: SfRangeSliderThemeData.lerp(a.rangeSliderThemeData, b.rangeSliderThemeData, t)!,
        mapsThemeData: SfMapsThemeData.lerp(a.mapsThemeData, b.mapsThemeData, t)!,
        treemapThemeData: SfTreemapThemeData.lerp(a.treemapThemeData, b.treemapThemeData, t)!);
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<SfPdfViewerThemeData>('pdfViewerThemeData', pdfViewerThemeData, defaultValue: defaultData.pdfViewerThemeData));
    properties.add(DiagnosticsProperty<SfChartThemeData>('chartThemeData', chartThemeData, defaultValue: defaultData.chartThemeData));
    properties.add(DiagnosticsProperty<SfCalendarThemeData>('calendarThemeData', calendarThemeData, defaultValue: defaultData.calendarThemeData));
    properties.add(DiagnosticsProperty<SfDataGridThemeData>('dataGridThemeData', dataGridThemeData, defaultValue: defaultData.dataGridThemeData));
    properties.add(DiagnosticsProperty<SfDataPagerThemeData>('dataPagerThemeData', dataPagerThemeData, defaultValue: defaultData.dataPagerThemeData));
    properties.add(DiagnosticsProperty<SfDateRangePickerThemeData>('dateRangePickerThemeData', dateRangePickerThemeData,
        defaultValue: defaultData.dateRangePickerThemeData));
    properties.add(DiagnosticsProperty<SfBarcodeThemeData>('barcodeThemeData', barcodeThemeData, defaultValue: defaultData.barcodeThemeData));
    properties.add(DiagnosticsProperty<SfGaugeThemeData>('gaugeThemeData', gaugeThemeData, defaultValue: defaultData.gaugeThemeData));
    properties
        .add(DiagnosticsProperty<SfRangeSelectorThemeData>('rangeSelectorThemeData', rangeSelectorThemeData, defaultValue: defaultData.rangeSelectorThemeData));
    properties.add(DiagnosticsProperty<SfRangeSliderThemeData>('rangeSliderThemeData', rangeSliderThemeData, defaultValue: defaultData.rangeSliderThemeData));
    properties.add(DiagnosticsProperty<SfSliderThemeData>('sliderThemeData', sliderThemeData, defaultValue: defaultData.sliderThemeData));
    properties.add(DiagnosticsProperty<SfMapsThemeData>('mapsThemeData', mapsThemeData, defaultValue: defaultData.mapsThemeData));
    properties.add(DiagnosticsProperty<SfTreemapThemeData>('treemapThemeData', treemapThemeData, defaultValue: defaultData.treemapThemeData));
  }
}
