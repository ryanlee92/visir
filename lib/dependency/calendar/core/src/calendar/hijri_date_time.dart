...
class HijriDateTime {
  ...
  HijriDateTime(this.year, this.month, this.day) : _date = convertToGregorianDate(null, year: year, month: month, day: day);
  ...
  bool operator ==(dynamic other) {
    ...
    return otherStyle.month == month && otherStyle.year == year && otherStyle.day == day;
  }
...
HijriDateTime convertToHijriDate(DateTime date) {
  ...
  final int julianNumber = (365.25 * (tYear + 4716)).floor() + (30.6001 * (tMonth + 1)).floor() + day - julianOffset - 1524;
...
DateTime convertToGregorianDate(HijriDateTime? date, {int year = 0, int month = 0, int day = 0}) {
  if (date != null) {
    return date._date;
  }
