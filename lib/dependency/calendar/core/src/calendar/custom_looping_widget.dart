...
class CustomScrollViewerLayout extends MultiChildRenderObjectWidget {
  ...
  ///
  /// ```
  const CustomScrollViewerLayout(List<Widget> children, this._navigationDirection, this._position, this._currentChildIndex) : super(children: children);
...
class _CustomScrollViewLayout extends RenderWrap {
  ...
  @override
  void performLayout() {
    double currentChildXPos = 0, firstChildXPos = 0, lastChildXPos = 0, currentChildYPos = 0, firstChildYPos = 0, lastChildYPos = 0;
    ...
    _lastChild = childAfter(firstChild!);
    _currentChild = lastChild;
