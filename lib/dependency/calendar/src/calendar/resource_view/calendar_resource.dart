...
class CalendarResource with Diagnosticable {
  ...
  CalendarResource({this.displayName = '', required this.id, this.image, this.color = Colors.lightBlue});
  ...
  bool operator ==(dynamic other) {
    ...
    return resource.displayName == displayName && resource.id == id && resource.image == image && resource.color == color;
  }
