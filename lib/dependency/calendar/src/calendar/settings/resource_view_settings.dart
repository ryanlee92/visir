...
class ResourceViewSettings with Diagnosticable {
  ...
  const ResourceViewSettings({this.size = 75, this.visibleResourceCount = -1, this.showAvatar = true, this.displayNameTextStyle})
      : assert(size >= 0),
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<TextStyle>('displayNameTextStyle', displayNameTextStyle));
  ...
  @override
  int get hashCode {
    return Object.hash(size, visibleResourceCount, showAvatar, displayNameTextStyle);
  }
}
