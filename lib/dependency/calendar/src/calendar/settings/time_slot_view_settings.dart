...
class TimeSlotViewSettings with Diagnosticable {
  ...
  @override
  int get hashCode {
    return Object.hash(startHour, endHour, Object.hashAll(nonWorkingDays), timeInterval, timeIntervalHeight, timeIntervalWidth, timeFormat,
        timelineAppointmentHeight, minimumAppointmentDuration, dateFormat, dayFormat, timeRulerSize, timeTextStyle);
  }
}
