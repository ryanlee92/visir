...
class ScheduleViewSettings with Diagnosticable {
  ...
  ScheduleViewSettings(
      ...
      required this.monthHeaderSettings,
      required this.weekHeaderSettings,
      required this.dayHeaderSettings,
  ...
  int get hashCode {
    return Object.hash(
        appointmentTextStyle, appointmentItemHeight, hideEmptyScheduleWeek, monthHeaderSettings, weekHeaderSettings, dayHeaderSettings, placeholderTextStyle);
  }
}
