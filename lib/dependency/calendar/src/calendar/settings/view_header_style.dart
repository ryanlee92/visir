...
class ViewHeaderStyle with Diagnosticable {
  ...
  const ViewHeaderStyle({this.backgroundColor, this.dateTextStyle, this.dayTextStyle});
  ...
  bool operator ==(dynamic other) {
    ...
    return otherStyle.backgroundColor == backgroundColor && otherStyle.dayTextStyle == dayTextStyle && otherStyle.dateTextStyle == dateTextStyle;
  }
