...
class MonthViewSettings with Diagnosticable {
  ...
  ///  }
  /// ```
  final ValueNotifier<double>? agendaViewHeight;
  ...
  bool operator ==(dynamic other) {
    ...
    return otherSetting.dayFormat == dayFormat &&
        ...
        otherSetting.showTrailingAndLeadingDates == showTrailingAndLeadingDates &&
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(IntProperty('appointmentDisplayCount', appointmentDisplayCount));
    properties.add(EnumProperty<MonthAppointmentDisplayMode>('appointmentDisplayMode', appointmentDisplayMode));
    properties.add(EnumProperty<MonthNavigationDirection>('navigationDirection', navigationDirection));
    properties.add(DoubleProperty('agendaItemHeight', agendaItemHeight));
    properties.add(DoubleProperty('agendaViewHeight', agendaViewHeight?.value));
...
class AgendaStyle with Diagnosticable {
  ...
  @override
  int get hashCode {
    return Object.hash(appointmentTextStyle, dayTextStyle, dateTextStyle, backgroundColor, placeholderTextStyle);
  }
}
...
class MonthCellStyle with Diagnosticable {
  ...
  bool operator ==(dynamic other) {
    ...
    return otherStyle.textStyle == textStyle &&
        ...
        otherStyle.trailingDatesBackgroundColor == trailingDatesBackgroundColor &&
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(ColorProperty('leadingDatesBackgroundColor', leadingDatesBackgroundColor));
  }
