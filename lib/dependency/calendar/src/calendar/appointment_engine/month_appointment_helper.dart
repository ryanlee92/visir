...
class MonthAppointmentHelper {
  static void _createVisibleAppointments(
    ...
    for (int i = 0; i < visibleAppointments.length; i++) {
      ...
      if ((appointment.actualStartTime.isBefore(visibleDates.last.add(Duration(days: 1))) && !appointment.actualStartTime.isBefore(visibleDates.first)) ||
  ...
  static void _createAppointmentInfoForSpannedAppointment(AppointmentView appointmentView, List<AppointmentView> appointmentCollection) {
    if (appointmentView.startIndex ~/ DateTime.daysPerWeek != appointmentView.endIndex ~/ DateTime.daysPerWeek) {
      ...
      appointmentView.endIndex = (((appointmentView.startIndex ~/ DateTime.daysPerWeek) + 1) * DateTime.daysPerWeek) - 1;
  ...
  static void _setAppointmentPosition(List<AppointmentView> appointmentViewCollection, AppointmentView appointmentView, int viewIndex) {
  ...
  static bool _isInterceptAppointments(AppointmentView appointmentView1, AppointmentView appointmentView2) {
    if (appointmentView1.startIndex <= appointmentView2.startIndex && appointmentView1.endIndex >= appointmentView2.startIndex ||
        appointmentView2.startIndex <= appointmentView1.startIndex && appointmentView2.endIndex >= appointmentView1.startIndex) {
      return true;
    }

    if (appointmentView1.startIndex <= appointmentView2.endIndex && appointmentView1.endIndex >= appointmentView2.endIndex ||
        appointmentView2.startIndex <= appointmentView1.endIndex && appointmentView2.endIndex >= appointmentView1.endIndex) {
      return true;
    }
  ...
  static int orderAppointmentViewBySpanned(AppointmentView appointmentView1, AppointmentView appointmentView2) {
    final index = AppointmentHelper.sortAppintment(appointmentView1.appointment, appointmentView2.appointment);
    ...
    final DateTime startTime1 = appointment1.isAllDay ? AppointmentHelper.convertToStartTime(appointment1.exactStartTime) : appointment1.exactStartTime;
    final DateTime startTime2 = appointment2.isAllDay ? AppointmentHelper.convertToStartTime(appointment2.exactStartTime) : appointment2.exactStartTime;
    ...
    final DateTime endTime1 = appointment1.isAllDay ? AppointmentHelper.convertToEndTime(appointment1.exactEndTime) : appointment1.exactEndTime;
    final DateTime endTime2 = appointment2.isAllDay ? AppointmentHelper.convertToEndTime(appointment2.exactEndTime) : appointment2.exactEndTime;
    ...
    return AppointmentHelper.sortAppintment(appointment1, appointment2);
  }

  static void _updateAppointmentPosition(List<AppointmentView> appointmentCollection, Map<int, List<AppointmentView>> indexAppointments) {
    appointmentCollection.sort(orderAppointmentViewBySpanned);
  ...
  static int getDateIndex(DateTime date, List<DateTime> visibleDates) {
    ...
    for (int i = count - DateTime.daysPerWeek; i >= 0; i -= DateTime.daysPerWeek) {
      ...
      if (currentDate.isBefore(date) || (currentDate.day == date.day && currentDate.month == date.month && currentDate.year == date.year)) {
