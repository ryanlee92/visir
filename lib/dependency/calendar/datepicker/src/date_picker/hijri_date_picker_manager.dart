...
class HijriDatePickerMonthViewSettings with Diagnosticable {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(IterableDiagnostics<HijriDateTime>(blackoutDates).toDiagnosticsNode(name: 'blackoutDates'));
    properties.add(IterableDiagnostics<HijriDateTime>(specialDates).toDiagnosticsNode(name: 'specialDates'));
...
class HijriDatePickerYearCellStyle with Diagnosticable {
  ...
  const HijriDatePickerYearCellStyle(
      {this.textStyle, this.todayTextStyle, this.disabledDatesTextStyle, this.cellDecoration, this.todayCellDecoration, this.disabledDatesDecoration});
  ...
  @override
  int get hashCode {
    return Object.hash(textStyle, todayTextStyle, disabledDatesTextStyle, disabledDatesDecoration, cellDecoration, todayCellDecoration);
  }
}
...
class HijriDatePickerController extends DateRangePickerValueChangeNotifier {
  ...
  set selectedDates(List<HijriDateTime>? dates) {
    ...
    _selectedDates = DateRangePickerHelper.cloneList(dates)!.cast<HijriDateTime>();
  ...
  set selectedRanges(List<HijriDateRange>? ranges) {
    ...
    _selectedRanges = DateRangePickerHelper.cloneList(ranges)!.cast<HijriDateRange>();
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty<HijriDateTime>('displayDate', displayDate));
    properties.add(DiagnosticsProperty<HijriDateTime>('selectedDate', selectedDate));
    properties.add(IterableDiagnostics<HijriDateTime>(selectedDates).toDiagnosticsNode(name: 'selectedDates'));
    properties.add(DiagnosticsProperty<HijriDateRange>('selectedRange', selectedRange));
    properties.add(IterableDiagnostics<HijriDateRange>(selectedRanges).toDiagnosticsNode(name: 'selectedRanges'));
...
/// callback.
typedef HijriDateRangePickerCellBuilder = Widget Function(BuildContext context, HijriDateRangePickerCellDetails cellDetails);

/// Signature for predicating dates for enabled date selections.
///
/// [SelectableDayPredicate] parameter used to specify allowable days in the
/// SfHijriDateRangePicker.
typedef HijriDatePickerSelectableDayPredicate = bool Function(HijriDateTime date);
