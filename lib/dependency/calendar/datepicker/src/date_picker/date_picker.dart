...
class SfDateRangePicker extends StatelessWidget {
  ...
  SfDateRangePicker(
      ...
      : assert(headerHeight >= -1),
        assert(minDate == null || maxDate == null || minDate.isBefore(maxDate) || minDate == maxDate),
...
class _SfDateRangePickerState extends State<_SfDateRangePicker> with SingleTickerProviderStateMixin {
  ...
  SfDateRangePickerThemeData _getPickerThemeData(SfDateRangePickerThemeData pickerTheme, ThemeData themeData) {
    ...
    return pickerTheme.copyWith(
        ...
        weekNumberBackgroundColor: pickerTheme.weekNumberBackgroundColor ?? colorScheme.onSurface.withValues(alpha: 0.08),
        ...
        blackoutDatesTextStyle: (widget.monthCellStyle.blackoutDateTextStyle == null && pickerTheme.blackoutDatesTextStyle == null)
        ...
        specialDatesTextStyle: (widget.monthCellStyle.specialDatesTextStyle == null && pickerTheme.specialDatesTextStyle == null)
        ...
        weekendDatesTextStyle: (widget.monthCellStyle.weekendTextStyle == null && pickerTheme.weekendDatesTextStyle == null)
        ...
        rangeSelectionColor: pickerTheme.rangeSelectionColor ?? colorScheme.primary.withValues(alpha: 0.1),
  ...
  Widget _getScrollViewItem(
    ...
    if (isHorizontal) {
      ...
      headerWidth =
          _getTextWidgetWidth(headerText, widget.headerHeight, pickerWidth, context, style: _datePickerTheme.headerTextStyle!, widthPadding: 20).width;
    }
  ...
  Widget _getActionsButton(double top, double actionButtonsHeight) {
    ...
    return Positioned(
      ...
      right: 0,
      height: actionButtonsHeight,
      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: <Widget>[todayButton, actionButtons]),
    );
  }
...
class _PickerHeaderViewState extends State<_PickerHeaderView> {
  ...
  Widget build(BuildContext context) {
    ...
    arrowColor = arrowColor.withValues(alpha: arrowColor.opacity * 0.6);
    ...
    if (showNavigationArrow &&
      ...
      nextArrowColor = nextArrowColor.withValues(alpha: arrowColor.opacity * 0.5);
    }
    ...
    if (showNavigationArrow &&
      ...
      prevArrowColor = prevArrowColor.withValues(alpha: arrowColor.opacity * 0.5);
    }
    ...
    final Container leftArrow = showNavigationArrow ? _getLeftArrow(arrowWidth, arrowColor, prevArrowColor, arrowSize) : Container();

    final Container rightArrow = showNavigationArrow ? _getRightArrow(arrowWidth, arrowColor, nextArrowColor, arrowSize) : Container();
  ...
  Container _getLeftArrow(double arrowWidth, Color arrowColor, Color prevArrowColor, double arrowSize) {
    return Container(
      ...
      child: VisirButton(
        type: VisirButtonAnimationType.scaleAndOpacity,
        style: VisirButtonStyle(
          backgroundColor: widget.headerStyle.backgroundColor ?? widget.datePickerTheme.headerBackgroundColor,
        ),
        onTap: widget.previousNavigationCallback,
        child: Icon(
  ...
  Container _getRightArrow(double arrowWidth, Color arrowColor, Color nextArrowColor, double arrowSize) {
    return Container(
      ...
      child: VisirButton(
        ...
        onTap: widget.nextNavigationCallback,
        child: Icon(
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int j = 0; j < count; j++) {
      ...
      for (int i = 0; i < DateTime.daysPerWeek; i++) {
        ...
        String dayText = DateFormat(monthViewSettings.dayFormat, locale.toString()).format(isHijri ? currentDate.toDateTime() : currentDate).toUpperCase();
...
class _PickerScrollViewState extends State<_PickerScrollView> with TickerProviderStateMixin {
  ...
  KeyEventResult _updateYearSelectionByKeyBoardNavigation(
      _PickerViewState currentVisibleViewState, _PickerView currentVisibleView, DateRangePickerView pickerView, KeyEvent event) {
  ...
  KeyEventResult _onKeyDown(FocusNode node, KeyEvent event) {
    ...
    if (HardwareKeyboard.instance.isShiftPressed && event.logicalKey == LogicalKeyboardKey.tab) {
  ...
  dynamic _updateSingleSelectionByKeyBoardKeys(KeyEvent event, _PickerView currentView) {
  ...
  dynamic _updateMultiAndRangeSelectionByKeyBoard(KeyEvent event, _PickerViewState currentState, _PickerView currentView) {
    dynamic selectedDate;
    if (HardwareKeyboard.instance.isShiftPressed && event.logicalKey == LogicalKeyboardKey.arrowRight) {
    ...
    } else if (HardwareKeyboard.instance.isShiftPressed && event.logicalKey == LogicalKeyboardKey.arrowLeft) {
      if (widget.picker.selectionMode == DateRangePickerSelectionMode.multiple) {
        selectedDate = _pickerStateDetails.selectedDates![_pickerStateDetails.selectedDates!.length - 1];
        do {
          selectedDate = addDays(selectedDate, -1);
    ...
    } else if (HardwareKeyboard.instance.isShiftPressed && event.logicalKey == LogicalKeyboardKey.arrowUp) {
      if (widget.picker.selectionMode == DateRangePickerSelectionMode.multiple) {
        selectedDate = _pickerStateDetails.selectedDates![_pickerStateDetails.selectedDates!.length - 1];
        do {
          selectedDate = addDays(selectedDate, -DateTime.daysPerWeek);
    ...
    } else if (HardwareKeyboard.instance.isShiftPressed && event.logicalKey == LogicalKeyboardKey.arrowDown) {
      if (widget.picker.selectionMode == DateRangePickerSelectionMode.multiple) {
        selectedDate = _pickerStateDetails.selectedDates![_pickerStateDetails.selectedDates!.length - 1];
        do {
          selectedDate = addDays(selectedDate, DateTime.daysPerWeek);
  ...
  dynamic _updateSelectedDate(KeyEvent event, _PickerViewState currentState, _PickerView currentView) {
    switch (widget.picker.selectionMode) {
      case DateRangePickerSelectionMode.single:
        {
...
class _PickerViewState extends State<_PickerView> with TickerProviderStateMixin {
        ...
        case DateRangePickerNavigationDirection.horizontal:
          {
            ...
            if (xPosition > weekNumberPanelWidth + singleViewWidth && xPosition < singleViewWidth + widget.picker.viewSpacing + (2 * weekNumberPanelWidth)) {
              return index;
      ...
      case DateRangePickerSelectionMode.multiRange:
        {
          ...
          if (!_isDragStart) {
            ...
            if (lastRange != null && lastRange.startDate != null) {
              final dynamic updatedRange = _getSelectedRangeOnDragUpdateYear(lastRange, selectedDate);
              if (DateRangePickerHelper.isRangeEquals(lastRange, updatedRange)) {
                return;
              }
  ...
  void _drawRangesSelectionForYear(dynamic selectedDate) {
    ...
    if (lastRange != null &&
        ...
        (lastRange.endDate == null || DateRangePickerHelper.isSameCellDates(lastRange.startDate, lastRange.endDate, widget.controller.view))) {
    ...
    if (count != _pickerStateDetails.selectedRanges!.length &&
        (lastRange.endDate == null || DateRangePickerHelper.isSameCellDates(lastRange.endDate, lastRange.startDate, widget.controller.view))) {
