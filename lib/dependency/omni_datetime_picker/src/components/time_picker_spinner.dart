...
class _TimePickerSpinnerState extends State<TimePickerSpinner> {
  ...
  void initState() {
    ...
    currentSelectedHourIndex = (currentTime!.hour % _getHourCount()) + _getHourCount();
  ...
  Widget build(BuildContext context) {
    List<Widget> contents = [
      Expanded(
        child: SizedBox(
          height: _getItemHeight() * 3 + verticalPadding * 2,
          child: spinner(
            hourController,
            _getHourCount(),
        ...
        child: ListView.builder(
          itemBuilder: (context, index) {
            ...
            return Container(
              ...
              child: Text(
                text,
                style: (currentSelectedAPIndex == index ? context.titleSmall : context.titleSmall)?.textColor(context.outlineVariant).appFont(context),
              ),
            );
          },
          ...
          padding: EdgeInsets.symmetric(vertical: verticalPadding.toDouble()),
        ),
      ),
    );
    ...
    Widget spinner = NotificationListener<ScrollNotification>(
      ...
      child: ScrollConfiguration(
        ...
        child: ListView.builder(
          ...
          itemCount: 4,
          physics: ItemScrollPhysics(itemHeight: _getItemHeight(), targetPixelsLimit: 0.1),
          padding: EdgeInsets.symmetric(vertical: verticalPadding.toDouble()),
        ),
      ),
    );
