...
import '../src/utils/bottom_sheet_suspended_curve.dart';
import '../src/utils/scroll_to_top_status_bar.dart';
...
class ModalBottomSheetState extends State<ModalBottomSheet> with TickerProviderStateMixin {
  ...
  void _handleScrollUpdate(ScrollNotification notification) {
    ...
    if (!ModalBottomSheet.isDismissible) return;
  ...
  Widget build(BuildContext context) {
    ...
    return ScrollToTopStatusBarHandler(child: child, scrollController: _scrollController);
  }
}
