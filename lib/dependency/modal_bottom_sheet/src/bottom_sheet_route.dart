...
class _ModalBottomSheetState<T> extends State<_ModalBottomSheet<T>> {
  ...
  SyncScrollControllerGroup? _scrollControllerSyncGroup;
  ...
  Widget build(BuildContext context) {
    ...
    _scrollControllerSyncGroup ??= SyncScrollControllerGroup();
    final scrollController = _scrollController ??= _scrollControllerSyncGroup!.addAndGet();

    return ModalScrollController(
      controller: scrollController,
      scrollControllerSyncGroup: _scrollControllerSyncGroup!,
      child: Builder(
