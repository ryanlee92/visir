...
typedef GetSpotRangeErrorPainter<T extends FlSpotErrorRangeCallbackInput> = FlSpotErrorRangePainter Function(
  T input,
);
...
class AxisLinesIndicatorPainter extends AxisSpotIndicatorPainter {
  ...
  void paint(
    ...
    final horizontalLine = axisPointIndicator.y == null || horizontalLineProvider == null ? null : horizontalLineProvider!(axisPointIndicator.y!);
    ...
    final verticalLine = axisPointIndicator.x == null || verticalLineProvider == null ? null : verticalLineProvider!(axisPointIndicator.x!);
