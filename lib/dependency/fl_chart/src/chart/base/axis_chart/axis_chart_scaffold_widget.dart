...
import 'package:Visir/dependency/fl_chart/src/chart/base/axis_chart/scale_axis.dart';
import 'package:Visir/dependency/fl_chart/src/chart/base/axis_chart/side_titles/side_titles_widget.dart';
import 'package:Visir/dependency/fl_chart/src/chart/base/axis_chart/transformation_config.dart';
import 'package:Visir/dependency/fl_chart/src/chart/base/custom_interactive_viewer.dart';
import 'package:Visir/dependency/fl_chart/src/extensions/fl_titles_data_extension.dart';
...
class _AxisChartScaffoldWidgetState extends State<AxisChartScaffoldWidget> {
  ...
  bool get _canScaleHorizontally => _transformationConfig.scaleAxis == FlScaleAxis.horizontal || _transformationConfig.scaleAxis == FlScaleAxis.free;

  bool get _canScaleVertically => _transformationConfig.scaleAxis == FlScaleAxis.vertical || _transformationConfig.scaleAxis == FlScaleAxis.free;

  @override
  void initState() {
    super.initState();
    _transformationController = _transformationConfig.transformationController ?? TransformationController();
  ...
  void didUpdateWidget(AxisChartScaffoldWidget oldWidget) {
    ...
    switch ((oldWidget.transformationConfig.transformationController, widget.transformationConfig.transformationController)) {
      case (null, null):
        break;
      ...
      case (TransformationController(), TransformationController()):
        if (oldWidget.transformationConfig.transformationController != widget.transformationConfig.transformationController) {
          _transformationController.removeListener(_transformationControllerListener);
          _transformationController = widget.transformationConfig.transformationController!;
          _transformationController.addListener(_transformationControllerListener);
        }
