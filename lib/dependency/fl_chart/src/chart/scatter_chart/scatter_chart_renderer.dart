...
import 'package:Visir/dependency/fl_chart/src/chart/scatter_chart/scatter_chart_painter.dart';
...
class RenderScatterChart extends RenderBaseChart<ScatterTouchResponse> {
  ...
  PaintHolder<ScatterChartData> get paintHolder => PaintHolder(data, targetData, textScaler, chartVirtualRect);
