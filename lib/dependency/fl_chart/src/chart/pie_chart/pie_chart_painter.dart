...
import 'package:Visir/dependency/fl_chart/src/chart/base/line.dart';
import 'package:Visir/dependency/fl_chart/src/chart/pie_chart/pie_chart_data.dart';
...
class PieChartPainter extends BaseChartPainter<PieChartData> {
  ...
  Path generateSectionPath(
    ...
    if (sectionSpace != 0) {
      ...
      final endLineSeparatorPath = createRectPathAroundLine(Line(endLineFrom, endLineTo), sectionSpace);
      try {
        sectionPath = Path.combine(
          PathOperation.difference,
          sectionPath,
