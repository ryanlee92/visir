...
import 'package:Visir/dependency/fl_chart/src/chart/radar_chart/radar_chart_renderer.dart';
...
class _RadarChartState extends AnimatedWidgetBaseState<RadarChart> {
  ...
  void forEachTween(TweenVisitor<dynamic> visitor) {
    _radarChartDataTween = visitor(
      ...
      widget.data,
      (dynamic value) => RadarChartDataTween(begin: value as RadarChartData, end: widget.data),
