...
import 'package:Visir/dependency/fl_chart/src/chart/radar_chart/radar_extension.dart';
...
class RadarEntry with EquatableMixin {
  ...
  /// Lerps a [RadarDataSet] based on [t] value, check [Tween.lerp].
  static RadarEntry lerp(RadarEntry a, RadarEntry b, double t) => RadarEntry(value: lerpDouble(a.value, b.value, t)!);
