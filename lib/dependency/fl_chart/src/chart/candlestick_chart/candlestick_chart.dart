...
import 'package:Visir/dependency/fl_chart/src/chart/base/axis_chart/axis_chart_scaffold_widget.dart';
...
import 'package:Visir/dependency/fl_chart/src/chart/base/base_chart/fl_touch_event.dart';
import 'package:Visir/dependency/fl_chart/src/chart/candlestick_chart/candlestick_chart_data.dart';
import 'package:Visir/dependency/fl_chart/src/chart/candlestick_chart/candlestick_chart_renderer.dart';
...
class _CandlestickChartState extends AnimatedWidgetBaseState<CandlestickChart> {
  ...
  CandlestickChartData _withTouchedIndicators(
    ...
    if (!candlestickChartData.candlestickTouchData.enabled || !candlestickChartData.candlestickTouchData.handleBuiltInTouches) {
      return candlestickChartData;
    }

    final spot = touchedSpots != null && touchedSpots!.spotIndex != -1 ? candlestickChartData.candlestickSpots[touchedSpots!.spotIndex] : null;
  ...
  CandlestickChartData _getData() {
    ...
    if (candlestickTouchData.enabled && candlestickTouchData.handleBuiltInTouches) {
      ...
      return widget.data.copyWith(
        candlestickTouchData: widget.data.candlestickTouchData.copyWith(touchCallback: _handleBuiltInTouch),
      );
    }
    return widget.data;
  }
