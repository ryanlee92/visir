...
import 'package:Visir/dependency/fl_chart/src/chart/bar_chart/bar_chart_painter.dart';
...
class RenderBarChart extends RenderBaseChart<BarTouchResponse> {
  ...
  PaintHolder<BarChartData> get paintHolder => PaintHolder(data, targetData, textScaler, chartVirtualRect);
