...
import 'package:Visir/dependency/fl_chart/src/chart/bar_chart/bar_chart_helper.dart';
import 'package:Visir/dependency/fl_chart/src/chart/bar_chart/bar_chart_renderer.dart';
    ...
    this.transformationConfig = const FlTransformationConfig(),
          ...
          switch (data.alignment) {
            ...
            BarChartAlignment.start =>
              transformationConfig.scaleAxis != FlScaleAxis.horizontal && transformationConfig.scaleAxis != FlScaleAxis.free,
            _ => true,
          },
