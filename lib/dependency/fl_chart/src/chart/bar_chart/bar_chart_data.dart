...
import 'package:Visir/dependency/fl_chart/src/extensions/color_extension.dart';
import 'package:Visir/dependency/fl_chart/src/utils/lerp.dart';
...
class BarChartData extends AxisChartData with EquatableMixin {
  ...
  BarChartData({
    ...
    this.errorIndicatorData = const FlErrorIndicatorData(),
       ...
       super(
         titlesData: titlesData ?? const FlTitlesData(topTitles: AxisTitles()),
  ...
  BarChartData lerp(BaseChartData a, BaseChartData b, double t) {
    if (a is BarChartData && b is BarChartData) {
      return BarChartData(
        ...
        errorIndicatorData: FlErrorIndicatorData.lerp(a.errorIndicatorData, b.errorIndicatorData, t),
      );
    } else {
...
enum BarChartAlignment { start, end, center, spaceEvenly, spaceAround, spaceBetween }
...
class BarChartGroupData with EquatableMixin {
  ...
  BarChartGroupData({required this.x, bool? groupVertically, List<BarChartRodData>? barRods, double? barsSpace, List<int>? showingTooltipIndicators})
  ...
  double get width {
    ...
    if (groupVertically) {
      ...
      final sumWidth = barRods.map((rodData) => rodData.width).reduce((first, second) => first + second);
  ...
  /// and replaces provided values.
  BarChartGroupData copyWith({int? x, bool? groupVertically, List<BarChartRodData>? barRods, double? barsSpace, List<int>? showingTooltipIndicators}) =>
      BarChartGroupData(
        x: x ?? this.x,
  ...
  static BarChartGroupData lerp(BarChartGroupData a, BarChartGroupData b, double t) => BarChartGroupData(
  ...
  /// Used for equality check, see [EquatableMixin].
  @override
  List<Object?> get props => [x, groupVertically, barRods, barsSpace, showingTooltipIndicators];
}
...
class BarChartRodData with EquatableMixin {
  ...
  /// Used for equality check, see [EquatableMixin].
  @override
  List<Object?> get props => [fromY, toY, toYErrorRange, width, borderRadius, borderDashArray, borderSide, backDrawRodData, rodStackItems, color, gradient];
}
...
class BarChartRodStackItem with EquatableMixin {
  ...
  /// )
  /// ```
  BarChartRodStackItem(this.fromY, this.toY, this.color, [this.borderSide = Utils.defaultBorderSide]);
  ...
  /// and replaces provided values.
  BarChartRodStackItem copyWith({double? fromY, double? toY, Color? color, BorderSide? borderSide}) =>
      BarChartRodStackItem(fromY ?? this.fromY, toY ?? this.toY, color ?? this.color, borderSide ?? this.borderSide);

  /// Lerps a [BarChartRodStackItem] based on [t] value, check [Tween.lerp].
  static BarChartRodStackItem lerp(BarChartRodStackItem a, BarChartRodStackItem b, double t) => BarChartRodStackItem(
...
class BackgroundBarChartRodData with EquatableMixin {
  ...
  BackgroundBarChartRodData({double? fromY, double? toY, bool? show, Color? color, this.gradient})
    : fromY = fromY ?? 0,
      toY = toY ?? 0,
      show = show ?? false,
  ...
  static BackgroundBarChartRodData lerp(BackgroundBarChartRodData a, BackgroundBarChartRodData b, double t) => BackgroundBarChartRodData(
    fromY: lerpDouble(a.fromY, b.fromY, t),
    toY: lerpDouble(a.toY, b.toY, t),
    color: Color.lerp(a.color, b.color, t),
    gradient: Gradient.lerp(a.gradient, b.gradient, t),
...
typedef GetBarTooltipItem = BarTooltipItem? Function(BarChartGroupData group, int groupIndex, BarChartRodData rod, int rodIndex);

/// Default implementation for [BarTouchTooltipData.getTooltipItem].
BarTooltipItem? defaultBarTooltipItem(BarChartGroupData group, int groupIndex, BarChartRodData rod, int rodIndex) {
...
class BarTooltipItem with EquatableMixin {
  ...
  BarTooltipItem(this.text, this.textStyle, {this.textAlign = TextAlign.center, this.textDirection = TextDirection.ltr, this.children});
  ...
  /// Used for equality check, see [EquatableMixin].
  @override
  List<Object?> get props => [text, textStyle, textAlign, textDirection, children];
}
...
/// of tooltip popup.
typedef GetBarTooltipColor = Color Function(BarChartGroupData group);
...
class BarTouchResponse extends AxisBaseTouchResponse {
  ...
  BarTouchResponse({required super.touchLocation, required super.touchChartCoordinate, required this.spot});
  ...
  /// and replaces provided values.
  BarTouchResponse copyWith({Offset? touchLocation, Offset? touchChartCoordinate, BarTouchedSpot? spot}) => BarTouchResponse(
...
class BarChartSpotErrorRangeCallbackInput extends FlSpotErrorRangeCallbackInput {
  BarChartSpotErrorRangeCallbackInput({required this.group, required this.groupIndex, required this.rod, required this.barRodIndex});
  ...
  @override
  List<Object?> get props => [group, groupIndex, rod, barRodIndex];
}
...
class BarChartDataTween extends Tween<BarChartData> {
  BarChartDataTween({required BarChartData begin, required BarChartData end}) : super(begin: begin, end: end);
