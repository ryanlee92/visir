...
import 'package:Visir/dependency/fl_chart/src/chart/line_chart/line_chart_painter.dart';
...
class RenderLineChart extends RenderBaseChart<LineTouchResponse> {
  ...
  PaintHolder<LineChartData> get paintHolder => PaintHolder(data, targetData, textScaler, chartVirtualRect);
