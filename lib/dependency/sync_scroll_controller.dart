...
class SyncScrollControllerGroup {
  ...
  ScrollController addAndGet() {
    final initialOffset =
        _attachedControllers.isEmpty ? initialScrollOffset : _attachedControllers.first.position.pixels;
    final controller = _SyncScrollController(this, initialScrollOffset: initialOffset);
...
class _SyncScrollController extends ScrollController {
  ...
  void attach(ScrollPosition position) {
    ...
    assert(syncPosition.owner == this, '_SyncScrollPosition cannot change controllers once created.');
