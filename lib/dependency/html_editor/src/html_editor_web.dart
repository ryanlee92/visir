...
import 'package:Visir/dependency/html_editor/src/widgets/html_editor_widget_web.dart';
...
class HtmlEditor extends StatelessWidget {
  HtmlEditor({
    ...
    this.htmlEditorOptions = const HtmlEditorOptions(
        backgroundColor: Colors.white, defaultFontColor: Colors.black, placeholderColor: Colors.grey, defaultFontSize: 14, defaultLineHeight: 22),
  ...
  Widget build(BuildContext context) {
    if (kIsWeb) {
      return HtmlEditorWidget(
        ...
        initBC: context,
        onScrollInsideIframe: onScrollInsideIframe,
      );
    } else {
