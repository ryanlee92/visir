...
import 'package:Visir/features/mail/presentation/widgets/mail_color_picker.dart';
import 'package:Visir/features/mail/presentation/widgets/mail_editor_menu_widget.dart';
...
class ToolbarWidgetState extends ConsumerState<ToolbarWidget> {
              ...
              child: Padding(
                ...
                child: CustomScrollView(
                  ...
                  slivers: [
                    SliverFillRemaining(
                      hasScrollBody: false,
                      child: Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: _buildChildren()),
                    ),
                  ],
                ),
              ),
      ...
      return PointerInterceptor(
        child: AbsorbPointer(
          ...
          child: Opacity(
            opacity: _enabled ? 1 : 0.5,
            child: Container(
              constraints: BoxConstraints(maxHeight: _isExpanded ? MediaQuery.of(context).size.height : widget.htmlToolbarOptions.toolbarItemHeight + 15),
              child: _isExpanded
                  ? Padding(
                      padding: const EdgeInsets.all(5.0),
                      child: Wrap(
                          ...
                          ..insert(
                            ...
                            Container(
                              ...
                              child: VisirButton(
                                ...
                                style: VisirButtonStyle(height: 32, borderRadius: BorderRadius.circular(4)),
                                child: Icon(_isExpanded ? Icons.expand_less : Icons.expand_more, color: Colors.grey),
                                onTap: () async {
                                  setState(mounted, this.setState, () {
  ...
  List<Widget> _buildChildren() {
    ...
    toolbarChildren.add(
      renderMenuButton(
        icon: VisirIconType.formatSize,
        showArrow: true,
        height: 178,
        items: [
          MenuItem(
            text: context.tr.mail_toolbar_font_size_small,
            textStyle: TextStyle(fontSize: 10, height: 16 / 10, color: context.onSurface),
            onTap: () async {
              final changed = 'h6';
              ...
              if (proceed) {
                ...
                widget.controller.evaluateJavascript(source: "\$('#summernote-2').summernote('fontSize', 10);");
                updateSelectedItem(changed);
              }
            },
          ),
          MenuItem(
            text: context.tr.mail_toolbar_font_size_normal,
            textStyle: TextStyle(fontSize: 12, height: 18 / 12, color: context.onSurface),
            onTap: () async {
              final changed = 'p';
              var proceed = await widget.htmlToolbarOptions.onDropdownChanged?.call(DropdownType.style, changed, updateSelectedItem) ?? true;
              if (proceed) {
                // widget.controller.execCommand('formatBlock', argument: changed);
                widget.controller.evaluateJavascript(source: "\$('#summernote-2').summernote('fontSize', 13);");
                updateSelectedItem(changed);
              }
            },
          ),
          MenuItem(
            text: context.tr.mail_toolbar_font_size_large,
            textStyle: TextStyle(fontSize: 16, height: 26 / 16, color: context.onSurface),
            onTap: () async {
              final changed = 'h2';
              var proceed = await widget.htmlToolbarOptions.onDropdownChanged?.call(DropdownType.style, changed, updateSelectedItem) ?? true;
              if (proceed) {
                // widget.controller.execCommand('formatBlock', argument: changed);
                widget.controller.evaluateJavascript(source: "\$('#summernote-2').summernote('fontSize', 18);");
                updateSelectedItem(changed);
              }
            },
          ),
          MenuItem(
            text: context.tr.mail_toolbar_font_size_huge,
            textStyle: TextStyle(fontSize: 24, height: 36 / 24, color: context.onSurface),
            onTap: () async {
              final changed = 'h1';
              var proceed = await widget.htmlToolbarOptions.onDropdownChanged?.call(DropdownType.style, changed, updateSelectedItem) ?? true;
              if (proceed) {
                // widget.controller.execCommand('formatBlock', argument: changed);
                widget.controller.evaluateJavascript(source: "\$('#summernote-2').summernote('fontSize', 32);");
                updateSelectedItem(changed);
              }
            },
          ),
    ...
    //           BoxDecoration(
    //               color: Theme.of(context).scaffoldBackgroundColor, border: Border.all(color: Theme.of(context).colorScheme.onSurface.withValues(alpha:0.12))),
    ...
    toolbarChildren.addAll([
      renderToggleButton(
        ...
        color: _fontSelected[0] ? context.primary : context.outlineVariant,
        onTap: () async {
          final index = 0;
      ...
      renderToggleButton(
        ...
        color: _fontSelected[1] ? context.primary : context.outlineVariant,
        onTap: () async {
          final index = 1;
      ...
      renderToggleButton(
        icon: VisirIconType.formatUnderline,
        color: _fontSelected[2] ? context.primary : context.outlineVariant,
        onTap: () async {
          final index = 2;
    ...
    toolbarChildren.add(
      PlatformX.isMobileView
          ? renderMenuButton(
              height: 12 + 36 * 2,
              width: 148,
              icon: VisirIconType.formatColor,
              showArrow: true,
              items: [
                MenuItem(text: context.tr.mail_toolbar_color_picker_background_color, onTap: () {}),
                MenuItem(text: context.tr.mail_toolbar_color_picker_font_color, onTap: () {}),
              ],
              replaceCutomWidth: 272,
              replaceMenuBuilders: (position, hideMenu) => [
                MailColorPicker(
                  type: MailColorPickerType.background,
                  backgroundColor: widget.htmlToolbarOptions.overlayColor,
                  position: position,
                  hideMenu: hideMenu,
                  initialFontColor: _foreColorSelected,
                  initialBackgroundColor: _backColorSelected,
                  onChangeFontColor: (color) async {
                    final index = 0;
                    ...
                    if (color == null) {
                      ...
                      widget.controller.execCommand('foreColor', argument: (color.value & 0xFFFFFF).toRadixString(16).padLeft(6, '0').toUpperCase());
                  ...
                  onChangeBackgroundColor: (color) async {
                    final index = 1;
                    ...
                    if (color == null) {
                      var proceed =
                          await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.highlightColor, _colorSelected[index], updateStatus) ?? true;
                      if (proceed) {
                      ...
                      widget.controller.execCommand('hiliteColor', argument: (color.value & 0xFFFFFF).toRadixString(16).padLeft(6, '0').toUpperCase());
                      setState(mounted, this.setState, () {
                        _backColorSelected = color;
                        _colorSelected[index] = !_colorSelected[index];
                      });
          ...
          : renderMenuButton(
              ...
              height: 358,
              showArrow: true,
              customMenuBuilder: (position, hideMenu) => MailColorPicker(
                type: MailColorPickerType.both,
                backgroundColor: widget.htmlToolbarOptions.overlayColor,
    ...
    if (widget.htmlToolbarOptions.renderSeparatorWidget) toolbarChildren.add(renderDivider());

    toolbarChildren.add(
      Builder(
        builder: (context) {
          // final selection = widget.state.selection;
          // final nodes = selection == null ? null : widget.state.getNodesInSelection(selection);
          final isLeft = _alignSelected[0];
          final isRight = _alignSelected[1];
          final isCenter = _alignSelected[2];
          ...
          return renderMenuButton(
            height: 12 + 36 * 4,
            icon: isLeft == true
                ? VisirIconType.formatAlignLeft
                : isRight == true
                ? VisirIconType.formatAlignRight
                : isCenter == true
                ? VisirIconType.formatAlignCenter
                : VisirIconType.formatAlignJustify,
            showArrow: true,
            items: [
              MenuItem(
                leading: VisirIcon(type: VisirIconType.formatAlignJustify, size: 20, isSelected: true),
                text: context.tr.mail_toolbar_align_justify,
                onTap: () {
              ...
              MenuItem(
                leading: VisirIcon(type: VisirIconType.formatAlignLeft, size: 20, isSelected: true),
                text: context.tr.mail_toolbar_align_left,
                onTap: () {
              ...
              MenuItem(
                leading: VisirIcon(type: VisirIconType.formatAlignCenter, size: 20, isSelected: true),
                text: context.tr.mail_toolbar_align_center,
                onTap: () {
              ...
              MenuItem(
                leading: VisirIcon(type: VisirIconType.formatAlignRight, size: 20, isSelected: true),
                text: context.tr.mail_toolbar_align_right,
                onTap: () {
    ...
    //                           if (t.getIcons()[index].icon == Icons.format_color_text) {
    //                             widget.controller
    //                                 .execCommand('foreColor', argument: (newColor!.value & 0xFFFFFF).toRadixString(16).padLeft(6, '0').toUpperCase());
    //                             setState(mounted, this.setState, () {
    ...
    //                           if (t.getIcons()[index].icon == Icons.format_color_fill) {
    //                             widget.controller
    //                                 .execCommand('hiliteColor', argument: (newColor!.value & 0xFFFFFF).toRadixString(16).padLeft(6, '0').toUpperCase());
    //                             setState(mounted, this.setState, () {
      ...
      Builder(
        builder: (context) {
          ...
          return renderToggleButton(
            ...
            color: _listSelected[index] ? context.primary : context.outlineVariant,
            onTap: () async {
    ...
    toolbarChildren.addAll([
      renderToggleButton(
        icon: VisirIconType.formatIndentIncrease,
      ...
      renderToggleButton(
        icon: VisirIconType.formatIndentDecrease,
        color: context.outlineVariant,
        onTap: () async {
      ...
      if (widget.htmlToolbarOptions.renderSeparatorWidget) renderDivider(),
    ]);
    ...
    //               } else {
    //                 await widget.controller.evaluateJavascript(source: "\$('#summernote-2').summernote('lineHeight', '$changed');");
    //               }
    //               updateSelectedItem(changed);
    //             }
    //           }
    ...
    //       var proceed =
    //           await widget.htmlToolbarOptions.onButtonPressed?.call(index == 0 ? ButtonType.ltr : ButtonType.rtl, _alignSelected[index], updateStatus) ??
    //               true;
    //       if (proceed) {
    //         if (kIsWeb) {
    ...
    toolbarChildren.addAll([
      renderToggleButton(
        ...
        onTap: () async {
          ...
          if (proceed) {
            ...
            result = await FilePicker.platform.pickFiles(type: FileType.image, withData: true, allowedExtensions: widget.htmlToolbarOptions.imageExtensions);
            ...
            if (proceed) {
              widget.controller.insertHtml(
                '<img src="data:image/${result.files.single.extension};base64,$base64Data" data-filename="${result.files.single.name}" style="width: 50%"/>',
              );
            }
          }
        },
      ...
      if (widget.signatures != null)
        renderMenuButton(
          height: 12 + 36 * (widget.signatures!.length + 1),
          icon: VisirIconType.signature,
          showArrow: false,
          items: [-1, ...widget.signatures!.map((e) => e.number)].map((signature) {
            return MenuItem(
              text: signature == -1 ? context.tr.mail_pref_signature_none : context.tr.mail_pref_signature_number(signature + 1),
              onTap: () {
                widget.onChangeSignature?.call(signature);
              },
            );
          }).toList(),
        ),
          ...
          onTap: () async {
            ...
            final attachments = result.files
                .map((file) {
                  ...
                  return MailFileEntity(id: Uuid().v4(), cid: '', name: file.name, data: File(path).readAsBytesSync(), mimeType: lookupMimeType(path) ?? '');
                })
                .whereType<MailFileEntity>()
                .toList();
            widget.onFileAdded?.call(attachments);
          },
        ),
    ]);
    ...
    if (PlatformX.isMobileView) {
      toolbarChildren.insert(0, SizedBox(width: 8));
      toolbarChildren.add(SizedBox(width: 8));
    }
  ...
  Widget renderToggleButton({required VisirIconType icon, required Color color, required VoidCallback onTap}) {
    return VisirButton(
      type: VisirButtonAnimationType.scaleAndOpacity,
      style: VisirButtonStyle(
        ...
        hoverColor: widget.htmlToolbarOptions.hoverColor,
        padding: EdgeInsets.all(6),
      ),
      onTap: onTap,
      child: VisirIcon(type: icon, size: 20, isSelected: true),
    );
  }
  ...
  bool isMenuShown() {
    return overlayEntry?.mounted == true;
  }

  void replacMenuToCustom({
    required GlobalKey key,
    required BuildContext context,
    required int index,
    List<Widget> Function(Offset offset, VoidCallback hideMenu)? replaceCustomMenuBuilders,
    double? width,
  }) {
    hideMenu();
    OverlayState overlayState = Overlay.of(Utils.mainContext);
    overlayEntry = OverlayEntry(
      builder: (context) {
        RenderBox box = key.currentContext?.findRenderObject() as RenderBox;
        Offset zeroPosition = box.localToGlobal(Offset.zero);
        double screenWidth = MediaQuery.of(context).size.width;
        double _width = min(MediaQuery.of(context).size.width, width ?? 200);
        bool isOverHorizontal = zeroPosition.dx + _width > screenWidth;
        bool isUnderHorizontal = zeroPosition.dx < 0;
        double horizontalMargin = 16;

        double zeroDx = isUnderHorizontal
            ? horizontalMargin
            : isOverHorizontal
            ? screenWidth - horizontalMargin - _width
            : zeroPosition.dx;

        final ratio = Utils.ref.read(zoomRatioProvider);
        final position = Offset(zeroDx / ratio, zeroPosition.dy - 4 / ratio);

        if (replaceCustomMenuBuilders != null && replaceCustomMenuBuilders(position, hideMenu).length > index) {
            ...
            child: Material(
              ...
              child: Stack(
                children: [
                  ...
                  replaceCustomMenuBuilders(position, hideMenu)[index],
                ],
              ),
            ),
          );
  ...
  void showMenu({
    required GlobalKey key,
    required BuildContext context,
    Widget Function(Offset offset, VoidCallback hideMenu)? customMenuBuilder,
    List<Widget> Function(Offset offset, VoidCallback hideMenu)? replaceMenuBuilders,
    List<MenuItem>? items,
    double? height,
    double? width,
    double? replaceCutomWidth,
  }) {
    hideMenu();
    OverlayState overlayState = Overlay.of(Utils.mainContext);
    overlayEntry = OverlayEntry(
            ...
            child: Material(
              ...
              child: Stack(
                children: [
                  ...
                  FadeIn(
                    preferences: AnimationPreferences(duration: Duration(milliseconds: 150), autoPlay: AnimationPlayStates.Forward),
                    child: customMenuBuilder(position, hideMenu),
                  ),
                ],
              ),
            ),
                    ...
                    child: FadeIn(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: widget.htmlToolbarOptions.overlayColor ?? context.surface,
                              ...
                              .mapIndexed(
                                (index, item) => Material(
                                  ...
                                  child: VisirButton(
                                    ...
                                    type: VisirButtonAnimationType.scaleAndOpacity,
                                    onTap: () {
                                      if (replaceMenuBuilders != null) {
                                        replacMenuToCustom(
                                          key: key,
                                          context: context,
                                          replaceCustomMenuBuilders: replaceMenuBuilders,
                                          width: replaceCutomWidth,
                                          index: index,
                                        );
                                      } else {
                                        item.onTap();
                                    ...
                                    child: Container(
                                      ...
                                      child: item.leading == null
                                          ? Row(
                                              children: [
                                                SizedBox(height: 20),
                                                Text(item.text, style: item.textStyle ?? context.bodyLarge?.textColor(context.onSurface)),
                                              ],
                                            )
                                          : Row(
                                              children: [
          ...
          child: Padding(
            ...
            child: showArrow
                ? PopupMenu(
                    ...
                    height: height,
                    width: width,
                    popup: Container(color: context.primary, child: customMenuBuilder?.call(Offset.zero, hideMenu)),
                    style: VisirButtonStyle(
                      height: 32,
                      hoverColor: widget.htmlToolbarOptions.hoverColor,
                    ...
                    child: Row(
                      children: [
                        VisirIcon(type: icon, size: 20, isSelected: true),
                        SizedBox(width: 6),
                ...
                : PopupMenu(
                    ...
                    popup: customMenuBuilder?.call(Offset.zero, hideMenu),
                    child: VisirIcon(type: icon, size: 20, isSelected: true),
                  ),
          ),
        );
  ...
  Widget renderDivider() {
    return Container(width: 0.5, height: 26, color: context.outline, margin: EdgeInsets.only(left: 8, right: 12));
  }
}
