<script lang="ts">
  ...
  onMount(() => {
    ...
    // Immediately redirect to the app even on failure (matching web/integration/failed/index.html behavior)
...
<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-red-200 via-orange-200 to-yellow-200 dark:from-red-900 dark:via-orange-900 dark:to-yellow-900">
